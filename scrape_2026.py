...
EVENTS_2026 = [
    ...
    ("401811931", "WM Phoenix Open",                        "2026"),
    ("401811932", "AT&T Pebble Beach Pro-Am",               "2026"),
    ("401811933", "The Genesis Invitational",               "2026"),
    ("401811934", "Cognizant Classic in The Palm Beaches",  "2026"),
    ("401811935", "Arnold Palmer Invitational",             "2026"),
    ("401811936", "Puerto Rico Open",                       "2026"),
    ("401811937", "THE PLAYERS Championship",               "2026"),
    ("401811938", "Valspar Championship",                   "2026"),
    ("401811939", "Texas Children's Houston Open",          "2026"),
    ("401811940", "Valero Texas Open",                      "2026"),
    ("401811941", "Masters Tournament",                     "2026"),
    ("401811942", "RBC Heritage",                           "2026"),
    ("401811944", "Cadillac Championship",                  "2026"),
    ("401811945", "Truist Championship",                    "2026"),
    ("401811946", "ONEflight Myrtle Beach Classic",         "2026"),
    ("401811947", "PGA Championship",                       "2026"),
    ("401811948", "THE CJ CUP Byron Nelson",                "2026"),
    ("401811949", "Charles Schwab Challenge",               "2026"),
    ("401811950", "the Memorial Tournament",                "2026"),
    ("401811951", "RBC Canadian Open",                      "2026"),
    ("401811952", "U.S. Open",                              "2026"),
...
def main():
    ...
    if latest_name:
        site_data = build_site_data(data, gnum, latest_name, latest_season, latest_scorecards)
